...
data class AppColorScheme(
    ...
    /** Цвет трека пустого макро-бара; используется для фона плашек (вес/активность/график). */
    val macroBarTrackColor: Color,
...
object AppColorSchemes {
    ...
    val Classic = AppColorScheme(
        ...
        macroBarTrackColor = Color(0xFFE6E0D6),
    ...
    val WarmDark = AppColorScheme(
        ...
        macroBarTrackColor = Color(0xFF1A1F28),
    ...
    val MatteDark = AppColorScheme(
        ...
        macroBarTrackColor = Color(0xFF2A2A2A),
